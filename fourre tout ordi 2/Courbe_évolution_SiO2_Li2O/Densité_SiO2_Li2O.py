...
X_net = np.array([[100 - x, 0, 0, 0, 0, 0, x, 0, 0, 0, 0, 0, 0] for x in X])
...
plt.plot(X, Y, c='r')
plt.grid()
plt.title("Composition: 100-x% SiO2, x% Li2O")
