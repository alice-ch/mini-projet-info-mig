...
class nn_glass_mig_vickers_v2(base_app):
    def __init__(self):

        # Main parameters
        self.name = "nn_glass_mig_vickers_v2"
    ...
    def run(self):
        ...
        # Load dataset
        dts = dataset(pms(name="glass_mig_vickers_v2",
                          path="C:/Users/adelie.saule/MIG/hummingbird-master/hummingbird-master/hummingbird/dts/glass_mig_vickers_v2",
                          data=pms(type="array",
                                   filename="compoV_v2.csv",
                                   skiprows=1),
        ...
        # Plot
        filename = "C:/Users/adelie.saule/MIG/hummingbird-master/hummingbird-master/results/nn_glass_mig_v2/loss.png"
        ...
        filename = "C:/Users/adelie.saule/MIG/hummingbird-master/hummingbird-master/results/nn_glass_mig_v2/comparison.png"
        y = np.hstack((yt, yp))
        e = np.abs(yt-yp)
