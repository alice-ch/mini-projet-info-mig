...
class nn_glass_mig_hardness_v2(base_app):
    def __init__(self):

        # Main parameters
        self.name = "nn_glass_mig_hardness_v2"
    ...
    def run(self):
        ...
        dts = dataset(pms(name="glass_mig_young",
                          path="C:/Users/adelie.saule/MIG/hummingbird-master/hummingbird-master/hummingbird/dts/glass_mig_hardness_v2",
                          data=pms(type="array",
                                   filename="compoT_v2.csv",
                                   skiprows=1),
        ...
        plot_scatter(filename, y,
                     title="True Hardness against prediction (test set), R² = " + str(round(r_sqr, 3)), c=e)
